"""
Django settings for just_beats project.
...
WSGI_APPLICATION = 'just_beats.wsgi.application'
...
SELENIUM_FIXTURE_USERNAME = os.environ.get("SELENIUM_FIXTURE_USERNAME")
SELENIUM_FIXTURE_PASSWORD = os.environ.get("SELENIUM_FIXTURE_PASSWORD")
