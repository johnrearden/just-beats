...
class TestModels(TestCase):
    ...
    def setUpTestData(cls):
        cls.test_user = User.objects.create(username='test_user', password='pass')
        cls.test_instrument = Instrument.objects.create(name='drum', url='audio/drum.wav')
        cls.test_drumloop = Drumloop.objects.create(creator=cls.test_user, name="model_tester")
    ...
    def test_track_str_method(self):
        ...
        track = Track.objects.create(
            ...
            drumloop=self.test_drumloop, 
            instrument=self.test_instrument)
        correct_output = f'{self.test_instrument.name}: {beats}, trk_vol={track_volume}, belongs to {track.drumloop.name}'
    ...
    def test_review_str_method(self):
        ...
        correct_output = f'Review of {self.test_drumloop.name} by {self.test_user.username} - stars = {review.rating}'
